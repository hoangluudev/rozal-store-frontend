...
import ItemRatingStatus from "./ItemRatingStatus";
      ...
      <Box width="100%">
        ...
        >
          ...
          <Stack flexDirection="row" alignItems="center" columnGap={1}>
            {itemData?.comparePrice &&
              itemData?.comparePrice !== itemData?.price && (
                <Typography
                  color="grey"
                  sx={{
                    fontWeight: 600,
                ...
                >
                  {convertToCurrency(itemData?.comparePrice)}
                </Typography>
              )}
            <Typography
              color="error"
            ...
            >
              {convertToCurrency(itemData?.price)}
            </Typography>
          </Stack>
        </Stack>
        <ItemRatingStatus
